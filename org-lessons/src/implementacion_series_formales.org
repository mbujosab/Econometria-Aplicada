...
#+TITLE: Lección 1 --- series con grado o cogrado arbitrarios
...
** Inversa con final e inversa con principio de un polinomio de grado uno
   ...
   :header-args: :tangle no
   :metadata: (slideshow . ((slide_type . skip)))
   :ID:       20e7c7c6-d6e1-46d5-8822-8e48f8c7e012
   :END:

#+attr_ipynb: (slideshow . ((slide_type . skip)))
Más abajo ([[id:69899898-728e-42e8-b441-0b7cdcf8f75c][sección 2]]) aparece una implementación en Python de las series con principio (con cogrado) y las series con final (con grado). Dicha implementación consiste en la definición de dos clases: la clase =SerieConPrincipio= y la clase =SerieConFinal=. 
...
#+RESULTS:
[[file:./.ob-jupyter/d17624a07b29bff25119a84cb7adb4d1a0c0d9fc.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/ea82b5a0869188f8842c477b8eb3442c247135ac.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/947df4a92ed4f1e251149486330e45bfcfcfaf10.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/ef9625ea7fa28f8c46bdf8db90958550f50baf31.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/f658d652fb3325334ef1ef3477a5ab6c9d50ebd7.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/fe9f6cba8b8f1cde002ac7f3a3faba62c856efd6.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/070570397d7f1f448bd62af27805d79b04609d5d.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/75c6965aed07f21d3f6572c28d2c805bc2fb171a.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/55e27875f9fe0fed918d445be9771bd3aa837a0d.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/5caf6a5500000e65af5336f3c8cc53b820b1b6e6.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/c807919826f404121e0d80d6f39dea0d04253233.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/1c0207cdef0158ec1522fdc3ca7f66c8f72cbc98.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/ed59ab8f6ed692c3c031ad433476db2eb6b8593b.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/dc5e3a9c1449c4dc7262af4e3dd0778722bc6763.png]]
...
#+BEGIN_SRC python :noweb yes :tangle ./implementacion_series_formales.py :eval no :exports none
<<imports>>
