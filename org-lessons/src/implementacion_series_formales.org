...
#+begin_src python :results output :exports both :tangle no :eval no
...
(require 'ox-ipynb)
(ox-ipynb-export-org-file-to-ipynb-file "implementacion_series_formales.org")
#+END_SRC

#+BEGIN_SRC sh :results silent
jupyter nbconvert --execute --inplace implementacion_series_formales.ipynb
#+END_SRC

#+BEGIN_SRC sh :results silent
jupyter nbconvert --config ../mycfg-GitHubPages.py --to slides --reveal-prefix "https://unpkg.com/reveal.js@5.2.1" --execute implementacion_series_formales.ipynb
#+END_SRC

#+BEGIN_SRC sh :results silent
jupyter nbconvert --execute --to html implementacion_series_formales.ipynb
#+END_SRC
