...
#+begin_abstract
Veremos tres funciones que describen las características correspondientes a los momentos de segundo Veremos la estructura de la función de autocorrelación (ACF), la función de autocorrelación parcial (PACF) y la densidad espectral en procesos lineales genéricos y hoy lo particularizaremos a procesos de ruido blanco y procesos AR($p$). También las Ecuaciones de Yule-Walker para un AR($p$) estacionario.
#+end_abstract
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :results file :output-dir ./img/lecc04/ :file ACF-AR2RojoVioleta.png :exports code :results silent
ar_params = [1, 0.1, -0.8]
ma_params = [1,]
fig = plot_arma_parametric_diagnostics(ar_params, ma_params, sigma2=1, lags=20)
...
#+RESULTS: raices-ar2RojoVioleta
:RESULTS:
|   | P. real  | P. imag. | Módulo  | Frecuencia | Periodo | Multip. |
|---+----------+----------+---------+------------+---------+---------|
| 1 | 1.18228  | 0.0      | 1.18228 | 0.0        | Inf     | 1       |
| 0 | -1.05728 | 0.0      | 1.05728 | 0.5        | 2.0     | 1       |
:END:



#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :results file :output-dir ./img/lecc04/ :file Sim-AR2RojoVioleta.png :results none
fig = plot_arma_analysis(ar_params, ma_params, seed=2026)
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :results file :output-dir ./img/lecc04/ :file ACF-ARverde .png :exports code :results silent
ar_params = [1, -0.1, +0.8]
ma_params = [1,]
fig = plot_arma_parametric_diagnostics(ar_params, ma_params, sigma2=1, lags=20)
...
#+RESULTS: raices-arverde
:RESULTS:
|   | P. real | P. imag.  | Módulo   | Frecuencia | Periodo  | Multip. |
|---+---------+-----------+----------+------------+----------+---------|
| 0 | 0.0625  | -1.116286 | 1.118034 | 0.241098   | 4.147685 | 1       |
| 1 | 0.0625  | 1.116286  | 1.118034 | 0.241098   | 4.147685 | 1       |
:END:


#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :results file :output-dir ./img/lecc04/ :file Sim-ARverde.png :results none
fig = plot_arma_analysis(ar_params, ma_params, seed=2026)
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :results file :output-dir ./img/lecc04/ :file ACF-AR2violeta.png :exports code :results silent
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :results file :output-dir ./img/lecc04/ :file Sim-AR2violeta.png :results none
fig = plot_arma_analysis(ar_params, ma_params, seed=2026)
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :results file :output-dir ./img/lecc04/ :file ACF-AR2rojo.png :exports code :results silent
ar_params = [1, -1.6, +0.64]
ma_params = [1,]
fig = plot_arma_parametric_diagnostics(ar_params, ma_params, sigma2=1, lags=20)
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :results file :output-dir ./img/lecc04/ :file Sim-AR2rojo.png :results none
fig = plot_arma_analysis(ar_params, ma_params, seed=2026)
...
** COMMENT Función de autocovarianzas para un ARMA($p,q$)          :noexport:
   :PROPERTIES:
   :metadata: (slideshow . ((slide_type . slide)))
   :END:
