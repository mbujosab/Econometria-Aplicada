...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+begin_src jupyter-python  :results file :output-dir ./img/lecc09/ :file Scatter-GNPvsMelanoma.png :exports code :results silent
...
#+begin_src jupyter-python  :exports results :results silent
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
Generamos un fichero =png= con los resultados de la estimación MCO para que se vea bien en las transparencias.
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python file :file ./img/lecc09/resultsModel1.png  :results silent
# print(results.summary() :results silent) Esta es la forma habitual de ver los resultados
repr_png(results.summary(slim=True).as_latex(),  "./img/lecc09/resultsModel1.png") # pero emplearé esta para importar los resultados como imagen png en el material de clase
#+END_SRC
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :results file :output-dir ./img/lecc09/ :file d_GNPvsd_Melanoma.png :exports code :results silent
# Crear figuras y ejes con proporción 15:4
fig, ax1 = plt.subplots(figsize=(15, 4))
...
Generamos un fichero =png= con los resultados de la estimación MCO para que se vea bien en las transparencias.
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python file :file ./img/lecc09/resultsModel2.png :results silent
...
1) Las series poseen /una tendencia común/ 
   (pues hay una combinación lineal entre ellas que cancela dicha tendencia).

2) /Existe un equilibrio a largo plazo entre dichas series/, 
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :exports both :results silent
path = '../datos/'
...
Y los graficamos:
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python :results file :output-dir ./img/lecc09/ :file UK_Interest_rates.png :exports code :results silent
# Crear figuras y ejes con proporción 15:4
fig, ax1 = plt.subplots(figsize=(15, 4))
# Representar Long
ax1.set_xlabel('Año')
...
#+BEGIN_SRC jupyter-python :results file :output-dir ./img/lecc09/ :file UK_Interest_ratesFirstDiff.png :exports code :results silent
# Crear figuras y ejes con proporción 15:4
fig, ax1 = plt.subplots(figsize=(15, 4))
# Representar Long
ax1.set_xlabel('Año')
...
# Ajustar el modelo MCO
model_UK_diff = sm.OLS(y_UK_diff, X_UK_diff).fit()
# Obtener el resumen del ajuste
summary_UK_diff = model_UK_diff.summary(slim=True)
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+begin_src jupyter-python  :exports results :results plain silent
# Definir variables independientes y dependientes
y_UK = df2['Short']
X_UK = df2['Long']
# Agregar una constante a la matriz de características
...
# Ajustar el modelo MCO
model_UK = sm.OLS(y_UK, X_UK).fit()
# Obtener el resumen del ajuste
summary_UK = model_UK.summary(slim=True)
print(summary_UK)
#+end_src
...
# por lo que *los tipos de interés a corto y largo plazo podrían estar cointegrados*.
...
#+RESULTS:
:RESULTS:
: /tmp/ipykernel_35581/3823668820.py:2: InterpolationWarning: The test statistic is outside of the range of p-values available in the
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+begin_src jupyter-python :results file :output-dir ./img/lecc09/ :file UK_Interest_rates_ACF.png :exports code :results silent
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
Generamos un fichero =png= con los resultados de la estimación MCO para las series en diferencias
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python file :file ./img/lecc09/resultsModel3.png  :results silent
repr_png(model_UK_diff.summary(slim=True).as_latex(),  "./img/lecc09/resultsModel3.png") # pero emplearé esta para importar los resultados como imagen png en el material de clase
#+END_SRC

#+attr_ipynb: (slideshow . ((slide_type . skip)))
Y otro con los resultados de la estimación MCO para las series en niveles
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python file :file ./img/lecc09/resultsModel4.png  :results silent
repr_png(model_UK.summary(slim=True).as_latex(),  "./img/lecc09/resultsModel4.png") # pero emplearé esta para importar los resultados como imagen png en el material de clase
#+END_SRC
