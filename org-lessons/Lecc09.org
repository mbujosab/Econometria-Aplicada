...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python file :file ./img/lecc09/resultsModel1.png  :results file none
...
Generamos un fichero =png= con los resultados de la estimación MCO para que se vea bien en las transparencias.
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python file :file ./img/lecc09/resultsModel2.png :results file none
...
#+RESULTS:
:RESULTS:
: /tmp/ipykernel_29100/3823668820.py:2: InterpolationWarning: The test statistic is outside of the range of p-values available in the
...
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python file :file ./img/lecc09/resultsModel3.png  :results file silent
repr_png(results_model_UK_diff.summary(slim=True).as_latex(),  "./img/lecc09/resultsModel3.png") # pero emplearé esta para importar los resultados como imagen png en el material de clase
#+END_SRC

#+attr_ipynb: (slideshow . ((slide_type . skip)))
Y otro con los resultados de la estimación MCO para las series en niveles
#+attr_ipynb: (slideshow . ((slide_type . skip)))
#+BEGIN_SRC jupyter-python file :file ./img/lecc09/resultsModel4.png  :results file silent
repr_png(results_model_UK.summary(slim=True).as_latex(),  "./img/lecc09/resultsModel4.png") # pero emplearé esta para importar los resultados como imagen png en el material de clase
#+END_SRC
