...
# Colores del arcoíris y sus nombres
colores = [
    ("#e81416", "Rojo"),
    ("#ffa500", "Naranja"),
    ("#faeb36", "Amarillo"),
...
franja_ancho = ancho // len(colores)  # Ancho de cada franja
...
for i, (color, nombre) in enumerate(colores):
    draw.rectangle([i * franja_ancho, 0, (i + 1) * franja_ancho, alto], fill=color)
    # Dibujar el nombre del color
    font = ImageFont.load_default()
    text_width, text_height = draw.textbbox((0, 0), nombre, font=font)[2:4]
    text_x = i * franja_ancho + (franja_ancho - text_width) / 2
    text_y = (alto - text_height) / 2
