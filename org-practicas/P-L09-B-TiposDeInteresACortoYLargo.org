...
#+end_src
donde =RutaAlDirectorioDelFichero= es la ruta al directorio donde guardó el fichero =UK_Interest_rates.csv=
#+latex: }
...
[[./P-L09-B-TiposDeInteresACortoYLargo/ShortyLong.png]]
#+END_CENTER
...
#+attr_hmlt: :width 500
#+ATTR_LATEX: :width 0.45\textwidth :center t
[[./P-L09-B-TiposDeInteresACortoYLargo/ScatterPlotShortyLong.png]]
#+END_CENTER
...
#+latex: {\vspace{0pt} \footnotesize
/o bien teclee en linea de comandos/:
#+name: Ajuste en primeras diferencias
#+begin_src gretl :tangle ./guiones/P-L09-B-TiposDeInteresACortoYLargo.inp :eval no 
...
#+begin_src gretl :tangle ./guiones/P-L09-B-TiposDeInteresACortoYLargo.inp :results none :exports none :eval no :noweb yes
outfile --quiet RegresionPrimerasDiferencias.txt
    <<Ajuste en primeras diferencias>>
end outfile
#+end_src
...
#+begin_src gretl :tangle ./guiones/P-L09-B-TiposDeInteresACortoYLargo.inp :results none :exports none :eval no 
...
Se rechaza la $H_0:$ /la serie es una realización de un proceso $I(1)$/ a un nivel de significación del 5% o mayor.
