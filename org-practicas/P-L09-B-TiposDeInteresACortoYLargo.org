...
#+begin_src gretl :tangle ./guiones/P-L09-B-TiposDeInteresACortoYLargo.inp :results none :eval no :exports none
...
Fíjese que ocurre justo lo esperado si hay una relación de tipo  
...
#+latex: {\vspace{10pt}
#+latex: \noindent
[[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L09-B-TiposDeInteresACortoYLargo.inp][P-L09-B-TiposDeInteresACortoYLargo.inp]]
#+latex: \vspace{10pt}
#+LATEX: \lstinputlisting{guiones/P-L09-B-TiposDeInteresACortoYLargo.inp}
#+LATEX: \clearpage }
