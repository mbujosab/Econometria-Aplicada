...
#+PROPERTY: Examen-FumadoresVsIncendios
#+BEGIN_SRC sh :exports none :results silent :var practica="Examen-FumadoresVsIncendios"
rm -fr $(pwd)/$practica
...
#+begin_src gretl :tangle guiones/Examen-FumadoresVsIncendios.inp :exports none :eval no
# ------------------------------------------------------------
# Copyright (C) 2025 Marcos Bujosa
# Licencia: GNU General Public License v3.0 o posterior
# Este código es software libre y puede ser redistribuido y/o
# modificado bajo los términos de la GPL.
...
- Ficheros: :: Versión del ejercicio en [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-pdf/Examen-FumadoresVsIncendios.pdf][pdf]]; [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/Examen-FumadoresVsIncendios.html][html]].
   ...
   - Guión de gretl: [[https://github.com/mbujosab/Econometria-Aplicada/blob/gh-pages/Practicas-html/guiones/Examen-FumadoresVsIncendios.inp][Examen-FumadoresVsIncendios.inp]]
...
#+BEGIN_SRC gretl :tangle guiones/Examen-FumadoresVsIncendios.inp :eval no
...
#+CAPTION: Series temporales
[[./Examen-FumadoresVsIncendios/Tasa_FumadoresyTasa_Incendios.png]] 
#+ATTR_LATEX: :width 0.5\textwidth :center
#+CAPTION: Diagrama de dispersión
[[./Examen-FumadoresVsIncendios/Tasa_IncendiosVsTasa_Fumadores.png]]
#+END_CENTER
...
#+BEGIN_SRC gretl :tangle guiones/Examen-FumadoresVsIncendios.inp :eval no :exports none
...
#+latex: {\footnotesize
#+include: ./Examen-FumadoresVsIncendios/adf_Tasa_Fumadores.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-FumadoresVsIncendios/kpss_Tasa_Fumadores.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-FumadoresVsIncendios/adf_Tasa_Incendios.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-FumadoresVsIncendios/kpss_Tasa_Incendios.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-FumadoresVsIncendios/modeloMCO.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-FumadoresVsIncendios/modeloMCO_en_diff.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-FumadoresVsIncendios/adf_uhat.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-FumadoresVsIncendios/kpss_uhat.txt example
#+latex: }
...
- Estadísticos de ajuste :: En este caso, en el que estos modelos ajustan variables distintas (=Tasa_Incendios= en el primer caso y =d_Tasa_Incendios= en el segundo), por tanto *los estadísticos de ajuste no son comparables*.
  ...
  No obstante, es evidente que la primera regresión muestra un elevado $R^2$ (el ajuste reproduce un elevado porcentaje de la varianza muestral de la =Tasa_Incendios=) y que, sin embargo, la segunda regresión muestra un bajísimo $R^2$ (un paupérrimo ajuste de los datos). No cabe comparar los R-cuadrado corregidos ya que estos modelos no están anidados (como se apuntaba más arriba).
