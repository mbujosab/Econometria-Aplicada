...
Marque las series =GNP= y =Melanoma= y pulse sobre ellas con el botón derecho del ratón. 
Seleccione */~Gráfico de dispersión XY~/* (elija =Melanoma= para el eje X y suprima la recta estimada). Guarde el gráfico como icono.
...
#+begin_src gretl :tangle ./guiones/P-L09-A-MelanomaYPNBenEEUU.inp :results none :eval no
...
#+latex: {\vspace{10pt}
#+latex: \noindent
[[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L09-A-MelanomaYPNBenEEUU.inp][P-L09-A-MelanomaYPNBenEEUU.inp]]
#+latex: \vspace{10pt}
#+LATEX: \lstinputlisting{guiones/P-L09-A-MelanomaYPNBenEEUU.inp}
#+LATEX: \clearpage }
