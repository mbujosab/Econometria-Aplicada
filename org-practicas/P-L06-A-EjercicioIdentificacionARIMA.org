...
#+PROPERTY: P-L07-A-EjercicioIdentificacionARIMA
#+BEGIN_SRC sh :exports none :results silent :var practica="P-L07-A-EjercicioIdentificacionARIMA"
rm -fr $(pwd)/$practica
...
#+begin_src gretl :tangle guiones/P-L07-A-EjercicioIdentificacionARIMA.inp :exports none :eval no
...
#+begin_src R :tangle guiones/P-L07-A-EjercicioIdentificacionARIMA.inp :results none :exports code 
...
- Ficheros
  - Versiones: [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-pdf/P-L07-A-EjercicioIdentificacionARIMA.pdf][pdf]]; [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/P-L07-A-EjercicioIdentificacionARIMA.html][html]].
  ...
  - Guión de gretl: [[https://github.com/mbujosab/Econometria-Aplicada/blob/gh-pages/Practicas-html/guiones/P-L07-A-EjercicioIdentificacionARIMA.inp][P-L07-A-EjercicioIdentificacionARIMA.inp]]
...
[[./P-L07-A-EjercicioIdentificacionARIMA/SerieEnNiveles.png]]
#+ATTR_LATEX: :width 0.4\textwidth :center
[[./P-L07-A-EjercicioIdentificacionARIMA/rango-media.png]] 
#+END_CENTER
...
#+BEGIN_CENTER
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./P-L07-A-EjercicioIdentificacionARIMA/SerieEnLogs.png]]
#+ATTR_LATEX: :width 0.4\textwidth :center
[[./P-L07-A-EjercicioIdentificacionARIMA/rango-media-enLogs.png]] 
#+END_CENTER
...
#+begin_src R :tangle guiones/P-L07-A-EjercicioIdentificacionARIMA.inp :results none :exports none :noweb yes
outfile --quiet AR1.txt
  <<Modelo ARMA 1 0 0 con cte>>
end outfile
#+end_src

#+include: ./P-L07-A-EjercicioIdentificacionARIMA/AR1.txt example
...
#+include: ./P-L07-A-EjercicioIdentificacionARIMA/test_ADF.txt example
...
#+include: ./P-L07-A-EjercicioIdentificacionARIMA/test_KPSS.txt example
...
#+BEGIN_CENTER
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./P-L07-A-EjercicioIdentificacionARIMA/SerieLogEnDiferencias.png]]
#+END_CENTER
...
#+include: ./P-L07-A-EjercicioIdentificacionARIMA/ARIMA110.txt example
...
#+include: ./P-L07-A-EjercicioIdentificacionARIMA/test_ADF_en_diff.txt example
...
#+include: ./P-L07-A-EjercicioIdentificacionARIMA/test_KPSS_en_diff.txt example
...
[[./P-L07-A-EjercicioIdentificacionARIMA/SerieLogEnDiferencias.png]]
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./P-L07-A-EjercicioIdentificacionARIMA/d_l_x_ACF-PACF.png]]
#+END_CENTER
...
#+include: ./P-L07-A-EjercicioIdentificacionARIMA/ARIMA010x100.txt example
...
#+include: ./P-L07-A-EjercicioIdentificacionARIMA/ARIMA210cte.txt example
...
#+include: ./P-L07-A-EjercicioIdentificacionARIMA/ARIMA210.txt example
...
#+BEGIN_CENTER
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./P-L07-A-EjercicioIdentificacionARIMA/Residuos.png]]
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./P-L07-A-EjercicioIdentificacionARIMA/residuosACF-PACF.png]]
#+END_CENTER
...
#+include: ./P-L07-A-EjercicioIdentificacionARIMA/ResiduosACF-PACF.txt example
...
#+include: ./P-L07-A-EjercicioIdentificacionARIMA/ContrasteNormalidadResiduos.txt example
