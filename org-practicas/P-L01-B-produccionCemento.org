...
#+begin_src gretl :tangle ./guiones/P-L01-B-produccionCemento.inp :eval no :exports none 
# ------------------------------------------------------------
...
#+begin_src gretl :tangle guiones/P-L01-B-produccionCemento.inp :exports none :eval no
...
Realizaremos una práctica similar a la anterior con los datos de /producción de cemento/ descargados desde la base de datos del [[https://www.bde.es/webbe/es/estadisticas/temas/estadisticas-economicas-generales.html][Banco de España]].

   | Guión: | [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L01-B-produccionCemento.inp][P-L01-B-produccionCemento.inp]] |
...
#+latex: {\vspace{10pt}
#+latex: \noindent
*Código completo de la práctica:* [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L01-B-produccionCemento.inp][P-L01-B-produccionCemento.inp]]
#+latex: \vspace{10pt}
#+LATEX: \lstinputlisting{guiones/P-L01-B-produccionCemento.inp}
#+LATEX: \clearpage }
