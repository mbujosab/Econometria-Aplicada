...
#+begin_src gretl :tangle ./guiones/P-L01-A-airlinePass.inp :eval no :exports none 
# ------------------------------------------------------------
...
* Número de viajeros internacionales
   ...
   | Guión: | [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L01-A-airlinePass.inp][P-L01-A-airlinePass.inp]] |
...
#+begin_src gretl :tangle ./guiones/P-L01-A-airlinePass.inp :eval no
open bjg
#+end_src
...
#+latex: {\vspace{0pt} \footnotesize \color{gray!70!black}
  #+NAME: Guardamos scatterplot como icono
  #+begin_src gretl :tangle ./guiones/P-L01-A-airlinePass.inp :eval no :results none
...
#+latex: {\vspace{10pt}
#+latex: \noindent
*Código completo de la práctica:* [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L01-A-airlinePass.inp][P-L01-A-airlinePass.inp]]
#+latex: \vspace{10pt}
#+LATEX: \lstinputlisting{guiones/P-L01-A-airlinePass.inp}
#+LATEX: \clearpage }
