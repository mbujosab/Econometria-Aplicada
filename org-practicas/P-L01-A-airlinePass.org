...
* Número de viajeros internacionales
   ...
   | Guión: | [[https://mbujosab.github.io/Econometria-Aplicada/Lecciones-html/Practicas/guiones/P-L01-A-airlinePass.inp][P-L01-A-airlinePass.inp]] |
...
#+latex: {\vspace{10pt}
#+latex: \noindent
*Código completo de la práctica* ~P-L01-A-airlinePass.inp~
#+latex: \vspace{10pt}
\lstinputlisting{guiones/P-L01-A-airlinePass.inp}
#+LATEX: \clearpage }
