...
#+PROPERTY: Examen-LetrasTesoroAmericano3y6meses
#+BEGIN_SRC sh :exports none :results silent :var practica="Examen-LetrasTesoroAmericano3y6meses"
rm -fr $(pwd)/$practica
...
#+begin_src gretl :tangle guiones/Examen-LetrasTesoroAmericano3y6meses.inp :exports none :eval no
...
#+begin_src gretl :tangle guiones/Examen-LetrasTesoroAmericano3y6meses.inp :eval no :exports code 
...
[[./Examen-LetrasTesoroAmericano3y6meses/TB3yTB6.png]]

#+END_CENTER

- Ficheros 
# [[https://github.com/mbujosab/EconometriaAplicada-SRC/tree/main/Ejercicios]]
   - Versión en [[https://mbujosab.github.io/Econometria-Aplicada/Lecciones-pdf/Practicas/LetrasTesoroAmericano3y6meses.pdf][pdf]]
   - Datos: [[https://mbujosab.github.io/Econometria-Aplicada/datos/LetrasTesoroAmericano3y6meses.gdt]]
   - Guión de gretl: [[https://mbujosab.github.io/Econometria-Aplicada/Lecciones-html/Practicas/guiones/lecc01-airlinePass.inp][LetrasTesoroAmericano3y6meses.inp]]
...
#+BEGIN_CENTER
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./Examen-LetrasTesoroAmericano3y6meses/TB3.png]]
#+ATTR_LATEX: :width 0.4\textwidth :center
[[./Examen-LetrasTesoroAmericano3y6meses/TB3ACF-PACF.png]] 
#+END_CENTER
...
#+BEGIN_SRC R :tangle guiones/Examen-LetrasTesoroAmericano3y6meses.inp :eval no :exports none
...
#+latex: {\footnotesize
#+include: ./Examen-LetrasTesoroAmericano3y6meses/RegresionAUX_TB3.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-LetrasTesoroAmericano3y6meses/adf_TB3.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-LetrasTesoroAmericano3y6meses/kpss_TB3.txt example
#+latex: }
...
#+BEGIN_CENTER
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./Examen-LetrasTesoroAmericano3y6meses/TB6.png]] 
#+ATTR_LATEX: :width 0.4\textwidth :center
[[./Examen-LetrasTesoroAmericano3y6meses/TB6ACF-PACF.png]] 
#+END_CENTER
...
#+latex: {\footnotesize
#+include: ./Examen-LetrasTesoroAmericano3y6meses/RegresionAUX_TB6.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-LetrasTesoroAmericano3y6meses/adf_TB6.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-LetrasTesoroAmericano3y6meses/kpss_TB6.txt example
#+latex: }
...
#+begin_src gretl :tangle guiones/Examen-LetrasTesoroAmericano3y6meses.inp :eval no :exports none
...
#+latex: {\footnotesize
#+include: ./Examen-LetrasTesoroAmericano3y6meses/test_cointegracion.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-LetrasTesoroAmericano3y6meses/modeloMCO.txt example
#+latex: }
...
#+latex: {\footnotesize
#+include: ./Examen-LetrasTesoroAmericano3y6meses/modeloMCO_en_diff.txt example
#+latex: }
...
- La etapa 3 es tan importante como el resto de etapas (en dicha etapa
  3 lo importante es que la pendiente sea significativa y que el ajuste
  no sea despreciable, pues indica que una serie ajusta parcialmente los datos de la otra). Las
...
- En un modelo de regresión con constante, el coeficiente de determinación ($R^2$)
