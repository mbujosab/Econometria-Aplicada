...
#+Title: Lección 5.A - Simulación de procesos AR
...
#+PROPERTY: P-L05-A-simulacion-procesos-AR
#+BEGIN_SRC sh  :exports none  :results silent :var practica="P-L05-A-simulacion-procesos-AR"
rm -fr $(pwd)/$practica
...
#+begin_src gretl :tangle guiones/P-L05-A-simulacion-procesos-AR.inp :exports none :eval no
...
* Objetivo de la práctica
   ...
   | Guión: | [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L03-D-simulacion-procesos-AR.inp][P-L05-A-simulacion-procesos-AR.inp]] |
...
#+BEGIN_SRC gretl  :noweb tangle  :tangle ./guiones/P-L05-A-simulacion-procesos-AR.inp :eval no
...
[[file:P-L05-A-simulacion-procesos-AR/RandomWalks.png]]
#+END_CENTER
...
#+BEGIN_SRC gretl :tangle ./guiones/P-L05-A-simulacion-procesos-AR.inp :eval no
...
[[file:P-L05-A-simulacion-procesos-AR/MuchosAR2_I.png]]
#+END_CENTER
...
\centering
\begin{tabular}{ll}
\includegraphics[width=0.45\textwidth]{./P-L05-A-simulacion-procesos-AR/histograma_t50.png} & \includegraphics[width=0.45\textwidth]{./P-L05-A-simulacion-procesos-AR/histograma_t100.png}\\
\includegraphics[width=0.45\textwidth]{./P-L05-A-simulacion-procesos-AR/histograma_t150.png} & \includegraphics[width=0.45\textwidth]{./P-L05-A-simulacion-procesos-AR/histograma_t200.png}\\
\end{tabular}
\end{table}
\end{center}
#+END_EXPORT
...
<div class="row">
  <div class="column">
    <img src="./P-L05-A-simulacion-procesos-AR/histograma_t50.png" alt="histograma_t50.png"">
    <img src="./P-L05-A-simulacion-procesos-AR/histograma_t100.png" alt="histograma_t100.png"">
  </div>
  <div class="column">
    <img src="./P-L05-A-simulacion-procesos-AR/histograma_t150.png" alt="histograma_t150.png"">
    <img src="./P-L05-A-simulacion-procesos-AR/histograma_t200.png" alt="histograma_t200.png"">
  </div>
</div>
#+END_EXPORT
...
[[file:P-L05-A-simulacion-procesos-AR/MuchosAR2_II.png]]
#+END_CENTER
...
\centering
\begin{tabular}{ll}
\includegraphics[width=0.45\textwidth]{./P-L05-A-simulacion-procesos-AR/histograma_II_t50.png} & \includegraphics[width=0.45\textwidth]{./P-L05-A-simulacion-procesos-AR/histograma_II_t100.png}\\
\includegraphics[width=0.45\textwidth]{./P-L05-A-simulacion-procesos-AR/histograma_II_t150.png} & \includegraphics[width=0.45\textwidth]{./P-L05-A-simulacion-procesos-AR/histograma_II_t200.png}\\
\end{tabular}
\end{table}
\end{center}
#+END_EXPORT
...
<div class="row">
  <div class="column">
    <img src="./P-L05-A-simulacion-procesos-AR/histograma_II_t50.png" alt="histograma_II_t50.png"">
    <img src="./P-L05-A-simulacion-procesos-AR/histograma_II_t100.png" alt="histograma_II_t100.png"">
  </div>
  <div class="column">
    <img src="./P-L05-A-simulacion-procesos-AR/histograma_II_t150.png" alt="histograma_II_t150.png"">
    <img src="./P-L05-A-simulacion-procesos-AR/histograma_II_t200.png" alt="histograma_II_t200.png"">
  </div>
</div>
#+END_EXPORT
...
#+ATTR_LATEX: :width 0.45\textwidth :center t
#+NAME: fig:RW
[[file:P-L05-A-simulacion-procesos-AR/RW.png]]
#+END_CENTER
...
#+ATTR_LATEX: :width 0.45\textwidth :center t
#+NAME: fig:ARMA
[[file:P-L05-A-simulacion-procesos-AR/ARMA.png]]
#+END_CENTER

* Código completo de la práctica

   | Guión completo: | [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L05-A-simulacion-procesos-AR.inp][P-L05-A-simulacion-procesos-AR.inp]] |

#+latex: \lstinputlisting{guiones/P-L05-A-simulacion-procesos-AR.inp}
