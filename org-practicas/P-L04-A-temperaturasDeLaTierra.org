...
[[file:../Lecciones-tmp/img/lecc04/ACF-MA1p.png]]

#+BEGIN_EXPORT latex
\vspace{10pt}
\noindent
\textbf{Código completo de la práctica}
\lstinputlisting{guiones/P-L04-A-temperaturasDeLaTierra.inp}
#+END_EXPORT
...
# #+latex: {\vspace{10pt}
# #+latex: \noindent
# *Código completo de la práctica* ~P-L04-A-temperaturasDeLaTierra.inp~
# #+latex: \vspace{10pt}
# \lstinputlisting{guiones/P-L04-A-temperaturasDeLaTierra.inp}
# #+LATEX: \clearpage }
