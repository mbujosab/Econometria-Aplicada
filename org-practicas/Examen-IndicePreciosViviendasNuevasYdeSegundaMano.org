...
>>>>>>> 294aba2f98721902cda002d49f550099f016d256
#+name: setup-listings
...
#+BEGIN_SRC sh :exports none :results silent :var practica="Examen-IndicePreciosViviendasNuevasYdeSegundaMano"
rm -fr $(pwd)/$practica
...
#+begin_src gretl :tangle guiones/Examen-IndicePreciosViviendasNuevasYdeSegundaMano.inp :exports none :eval no
...
Estadística.
<<<<<<< HEAD
#+begin_src gretl :tangle guiones/Examen-IndicePreciosViviendasNuevasYdeSegundaMano.inp :eval no :exports none
=======
#+begin_src gretl :tangle guiones/Examen-IndicePreciosViviendasNuevasYdeSegundaMano.inp ::eval no :exports none
>>>>>>> 294aba2f98721902cda002d49f550099f016d256
open ../../datos/IndicePreciosViviendasNuevasYdeSegundaMano.gdt
#+end_src
...
- Ficheros 
   - Versiones: [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-pdf/Examen-IndicePreciosViviendasNuevasYdeSegundaMano.pdf][pdf]]; [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/Examen-IndicePreciosViviendasNuevasYdeSegundaMano.html][html]].
   - Datos: [[https://github.com/mbujosab/Econometria-Aplicada/blob/gh-pages/datos/SerieCuentasFinancierasBE.gdt][IndicePreciosViviendasNuevasYdeSegundaMano.gdt]]
   - Guión de gretl: [[https://github.com/mbujosab/Econometria-Aplicada/blob/gh-pages/Practicas-html/guiones/Examen-IndicePreciosViviendasNuevasYdeSegundaMano.inp][Examen-IndicePreciosViviendasNuevasYdeSegundaMano.inp]]


* Gráfico de las tasas de variación los índices de precios

#+begin_src gretl :tangle guiones/Examen-IndicePreciosViviendasNuevasYdeSegundaMano.inp :results none :exports code :eval no
...
[[./Examen-IndicePreciosViviendasNuevasYdeSegundaMano/TasasDeVariacionAnual.png]]
#+END_CENTER
...
#+begin_src gretl :tangle guiones/Examen-IndicePreciosViviendasNuevasYdeSegundaMano.inp :results none :exports none :noweb yes
outfile --quiet ARIMA_T4IPVN.txt
  <<Modelo ARIMA_T4IPVN>>
end outfile
#+end_src

#+include: ./Examen-IndicePreciosViviendasNuevasYdeSegundaMano/ARIMA_T4IPVN.txt example
...
#+begin_src gretl :tangle guiones/Examen-IndicePreciosViviendasNuevasYdeSegundaMano.inp :results none :exports none :noweb yes :eval no
outfile --quiet ARIMA_T4IPV2M.txt
  <<Modelo ARIMA_T4IPV2M>>
end outfile
#+end_src

#+include: ./Examen-IndicePreciosViviendasNuevasYdeSegundaMano/ARIMA_T4IPV2M.txt example
...
#+include: ./Examen-IndicePreciosViviendasNuevasYdeSegundaMano/ARMAX_T4IPVN.txt example
...
- los errores de ajuste tienen una menor desviación típica (=D.T. innovaciones= de =1,943328= frente a =2,208917=).

# - tiene coeficientes de determinación más elevados; tanto el ordinario, $R^2$, (=0,917639= frente a =0,889602=) como el corregido  por los grados de libertad (=0,916219= frente a =0,889602=) y
