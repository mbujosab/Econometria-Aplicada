...
#+PROPERTY: P-L07-B-SegundoEjercicioIdentificacionARIMA
#+BEGIN_SRC sh :exports none :results silent :var practica="P-L07-B-SegundoEjercicioIdentificacionARIMA"
rm -fr $(pwd)/$practica
...
#+BEGIN_SRC gretl :tangle guiones/P-L07-B-SegundoEjercicioIdentificacionARIMA.inp :exports none :eval no
# ------------------------------------------------------------
...
Cargue la serie de datos simulados [[https://github.com/mbujosab/Econometria-Aplicada/blob/gh-pages/datos/IdentificaEstosARIMA/00c296-12.gdt][00c296-12.gdt]]

#+begin_src R :tangle guiones/P-L07-B-SegundoEjercicioIdentificacionARIMA.inp :results none :exports code 
...
3) [[Diferencias estacionales][Determine si es necesario tomar una diferencia estacional de la serie]]
4) [[Estacionariedad en media][Determine si es necesario tomar una o más diferencias regulares de la serie]]
5) [[Primer intento de búsqueda de un modelo ARIMA][Encuentre un modelo ARIMA para la serie que sea lo más parsimonioso posible, pero cuyos residuos se puedan considerar /ruido blanco/.]]

- Ficheros
  - Versiones: [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-pdf/P-L07-B-SegundoEjercicioIdentificacionARIMA.pdf][pdf]]; [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/P-L07-B-SegundoEjercicioIdentificacionARIMA.html][html]].
  - Datos: [[https://github.com/mbujosab/Econometria-Aplicada/blob/gh-pages/datos/IdentificaEstosARIMA/00c296-12.gdt][00c296-12.gdt]]
  - Guión de gretl: [[https://github.com/mbujosab/Econometria-Aplicada/blob/gh-pages/Practicas-html/guiones/P-L07-B-SegundoEjercicioIdentificacionARIMA.inp][P-L07-B-SegundoEjercicioIdentificacionARIMA.inp]]
...
[[./P-L07-B-SegundoEjercicioIdentificacionARIMA/SerieEnNiveles.png]]
#+ATTR_LATEX: :width 0.4\textwidth :center
[[./P-L07-B-SegundoEjercicioIdentificacionARIMA/rango-media.png]] 
#+END_CENTER
...
[[./P-L07-B-SegundoEjercicioIdentificacionARIMA/SerieEnNiveles.png]]
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./P-L07-B-SegundoEjercicioIdentificacionARIMA/x_ACF-PACF.png]]
#+END_CENTER
...
#+begin_src R :tangle guiones/P-L07-B-SegundoEjercicioIdentificacionARIMA.inp :results none :exports none :noweb yes
outfile --quiet ARIMA000x100.txt
  <<Modelo ARIMA_000x100 con cte>>
end outfile
#+end_src

#+include: ./P-L07-B-SegundoEjercicioIdentificacionARIMA/ARIMA000x100.txt example
...
#+BEGIN_CENTER
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./P-L07-B-SegundoEjercicioIdentificacionARIMA/SerieEnDiferencias.png]]
#+END_CENTER
...
#+BEGIN_CENTER
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./P-L07-B-SegundoEjercicioIdentificacionARIMA/sd_x_ACF-PACF.png]]
#+END_CENTER
...
#+include: ./P-L07-B-SegundoEjercicioIdentificacionARIMA/ARIMA110.txt example
...
#+include: ./P-L07-B-SegundoEjercicioIdentificacionARIMA/test_ADF_en_diff.txt example
...
#+include: ./P-L07-B-SegundoEjercicioIdentificacionARIMA/test_KPSS_en_diff.txt example
...
#+include: ./P-L07-B-SegundoEjercicioIdentificacionARIMA/ARIMA110cte.txt example
...
#+include: ./P-L07-B-SegundoEjercicioIdentificacionARIMA/ARIMA100x010.txt example
...
#+BEGIN_CENTER
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./P-L07-B-SegundoEjercicioIdentificacionARIMA/Residuos.png]]
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./P-L07-B-SegundoEjercicioIdentificacionARIMA/residuosACF-PACF.png]]
#+END_CENTER
...
#+include: ./P-L07-B-SegundoEjercicioIdentificacionARIMA/ResiduosACF-PACF.txt example
...
#+include: ./P-L07-B-SegundoEjercicioIdentificacionARIMA/ContrasteNormalidadResiduos.txt example
...
simulado... *¡pues hemos identificado un modelo distinto del simulado!*
...
#+include: ./P-L07-B-SegundoEjercicioIdentificacionARIMA/ARIMAsimulado.txt example

El ajuste es parecido (fíjese en los coeficientes de determinación) pero solo el parámetro los parámetros no son significativos (aunque $\phi_1$ toma un valor relativamente próximo al del modelo anterior). 
Por tanto...
#+latex: \bigskip
...
La explicación es que en el modelo estimado, el factor $(1 + 0,09879\mathsf{B})$ del polinomio AR casi se cancela con el polinomio MA $\;(1 + 0,1149\mathsf{B})$. 
Por eso hemos encontrado un modelo más parsimonioso y que funciona OK.
#+latex: \bigskip


*_Ahora escoja al azar nuevas series del  [[https://github.com/mbujosab/Econometria-Aplicada/tree/main/datos/IdentificaEstosARIMA][directorio]] (dispone de centenares de series simuladas con distintos modelos) y practique la identificación hasta que adquiera seguridad._*

* Código completo de la práctica

#+latex: {\vspace{10pt}
#+latex: \noindent
[[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L07-B-SegundoEjercicioIdentificacionARIMA.inp][P-L07-B-SegundoEjercicioIdentificacionARIMA.inp]]
#+latex: \vspace{10pt}
#+LATEX: \lstinputlisting{guiones/P-L07-B-SegundoEjercicioIdentificacionARIMA.inp}
#+LATEX: \clearpage }
