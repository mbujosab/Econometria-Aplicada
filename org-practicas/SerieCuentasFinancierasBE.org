...
#+PROPERTY: SerieCuentasFinancierasBE
#+BEGIN_SRC sh  :exports none  :results silent :var practica="SerieCuentasFinancierasBE"
rm -fr $(pwd)/SerieCuentasFinancierasBE
mkdir -p $(pwd)/SerieCuentasFinancierasBE 
DIRECTORIO="$(pwd)/SerieCuentasFinancierasBE" gretlcli -b $(pwd)/guiones/SerieCuentasFinancierasBE.inp
# zip SerieCuentasFinancierasBE SerieCuentasFinancierasBE.* SerieCuentasFinancierasBE/*
#+END_SRC

#+BEGIN_SRC sh  :exports none :results silent :var practica="SerieCuentasFinancierasBE" :eval no
zip SerieCuentasFinancierasBE SerieCuentasFinancierasBE.* SerieCuentasFinancierasBE/*
#+END_SRC


#+begin_src R :tangle guiones/SerieCuentasFinancierasBE.inp :exports none :eval no
...
- Ficheros 
   ...
   - Datos: [[https://mbujosab.github.io/Econometria-Aplicada/datos/SerieCuentasFinancierasBE.gdt][SerieCuentasFinancierasBE.gdt]]
   - Guión de gretl: [[https://mbujosab.github.io/Econometria-Aplicada/Lecciones-html/Practicas/guiones/SerieCuentasFinancierasBE.inp][SerieCuentasFinancierasBE.inp]]
...
#+begin_src R :tangle guiones/SerieCuentasFinancierasBE.inp :eval no :exports code 
...
#+begin_src R :tangle guiones/SerieCuentasFinancierasBE.inp :eval no :exports none
...
#+begin_src R :tangle guiones/SerieCuentasFinancierasBE.inp :eval no :exports none :noweb no-export 
# añadido para guardar los resultados en un fichero de texto
...
#+begin_src R :tangle guiones/SerieCuentasFinancierasBE.inp :eval no :exports none :noweb yes 
# añadido para guardar los resultados en un fichero de texto
