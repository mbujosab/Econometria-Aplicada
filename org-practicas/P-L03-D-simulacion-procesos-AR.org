...
#+Title: Lección 3.D - Simulación de procesos AR
...
#+PROPERTY: P-L03-D-simulacion-procesos-AR
#+BEGIN_SRC sh  :exports none  :results silent :var practica="P-L03-D-simulacion-procesos-AR"
rm -fr $(pwd)/$practica
...
#+begin_src gretl :tangle guiones/P-L03-D-simulacion-procesos-AR.inp :exports none :eval no
...
* Objetivo de la práctica
   ...
   | Guión: | [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L03-D-simulacion-procesos-AR.inp][P-L03-D-simulacion-procesos-AR.inp]] |
...
Consideremos el proceso estocástico $\boldsymbol{Y}$ definido como la solución de la ecuación en diferencias:
\[
...
Este proceso se conoce con el nombre de /proceso auto-regresivo/.
# O si lo prefiere
# \[
...
Como en los casos anteriores, para poder simularlo necesitamos cambiar el escenario y asumir que el proceso comienza en un instante \(t = 0\) (por ejemplo con con \(Y_0 = 0\)); pero además la estrategia debe ser distinta, pues cada valor $Y_t$ simulado debe emplearse para calcular uno o más valores futuros $Y_j$.[fn::En el caso del paseo aleatorio pudimos proceder de este nuevo modo, pero optamos por simularlo como una suma acumulada de los valores tomados por $\boldsymbol{U}$.]
#+latex: \bigskip
...
Y necesitamos definir un polinomio autoregresivo. 
Implementamos el polinomio con un vector fila; por ejemplo:
#+BEGIN_SRC gretl :eval no
...
Para cada instante, cada una de las partes en la suma es distinta, pues debe calcularse con valores distintos.
...
3. Escriba su guión en Gretl y pruebe si funciona. 
   Si no lo hace, piense cuál puede ser el error y corríjalo.
...
#+BEGIN_SRC gretl  :noweb tangle  :tangle ./guiones/P-L03-D-simulacion-procesos-AR.inp :eval no
...
[[file:P-L03-D-simulacion-procesos-AR/RandomWalks.png]]
#+END_CENTER
...
#+BEGIN_SRC gretl :tangle ./guiones/P-L03-D-simulacion-procesos-AR.inp :eval no
...
[[file:P-L03-D-simulacion-procesos-AR/MuchosAR2_I.png]]
#+END_CENTER

La figura [[fig:MuchosAR2_I]] presenta 300 realizaciones del proceso
\((1-1.6\mathsf{B}+.64\mathsf{B}^2)Y_t = U_t\); 
con la función que hemos programado. 
El proceso comienza siempre con el valor cero, pero la probabilidad de que tome valores alejados de cero crece rápidamente y para estabilizarse inmediatamente. 
...
\centering
\begin{tabular}{ll}
\includegraphics[width=0.45\textwidth]{./P-L03-D-simulacion-procesos-AR/histograma_t50.png} & \includegraphics[width=0.45\textwidth]{./P-L03-D-simulacion-procesos-AR/histograma_t100.png}\\
\includegraphics[width=0.45\textwidth]{./P-L03-D-simulacion-procesos-AR/histograma_t150.png} & \includegraphics[width=0.45\textwidth]{./P-L03-D-simulacion-procesos-AR/histograma_t200.png}\\
\end{tabular}
\end{table}
\end{center}
#+END_EXPORT
...
<div class="row">
  <div class="column">
    <img src="./P-L03-D-simulacion-procesos-AR/histograma_t50.png" alt="histograma_t50.png"">
    <img src="./P-L03-D-simulacion-procesos-AR/histograma_t100.png" alt="histograma_t100.png"">
  </div>
  <div class="column">
    <img src="./P-L03-D-simulacion-procesos-AR/histograma_t150.png" alt="histograma_t150.png"">
    <img src="./P-L03-D-simulacion-procesos-AR/histograma_t200.png" alt="histograma_t200.png"">
  </div>
</div>
#+END_EXPORT
...
Por ejemplo con el polinomio $\boldsymbol{\phi}(\mathsf{B}) = 1+0.1\mathsf{B}-0.9\mathsf{B}^2  = (1+\mathsf{B})(1-0.8\mathsf{B})$; es decir, simule el modelo
\[
...
#+BEGIN_CENTER
#+CAPTION: Figura con 300 simulaciones del modelo \(Y_t = -0.1Y_{t-1} + 0.9Y_{t-2} + U_t\).
#+attr_org: :width 500
#+ATTR_LATEX: :width 0.45\textwidth :center t
#+NAME: fig:MuchosAR2_II
[[file:P-L03-D-simulacion-procesos-AR/MuchosAR2_II.png]]
#+END_CENTER
...
Se observa que la media de estas distribuciones es aproximadamente cero en los cuatro casos, 
y que la desviación típica no deja de crecer. Si calcula las raíces de este polinomio comprobará que son dos raíces, una es $-1$ y otra es $1.25$, es decir, el proceso no es estacionario ya que no todas sus raíces tienen un módulo mayor que $1$; y las simulaciones lo reflejan.
...
\centering
\begin{tabular}{ll}
\includegraphics[width=0.45\textwidth]{./P-L03-D-simulacion-procesos-AR/histograma_II_t50.png} & \includegraphics[width=0.45\textwidth]{./P-L03-D-simulacion-procesos-AR/histograma_II_t100.png}\\
\includegraphics[width=0.45\textwidth]{./P-L03-D-simulacion-procesos-AR/histograma_II_t150.png} & \includegraphics[width=0.45\textwidth]{./P-L03-D-simulacion-procesos-AR/histograma_II_t200.png}\\
\end{tabular}
\end{table}
\end{center}
#+END_EXPORT
...
<div class="row">
  <div class="column">
    <img src="./P-L03-D-simulacion-procesos-AR/histograma_II_t50.png" alt="histograma_II_t50.png"">
    <img src="./P-L03-D-simulacion-procesos-AR/histograma_II_t100.png" alt="histograma_II_t100.png"">
  </div>
  <div class="column">
    <img src="./P-L03-D-simulacion-procesos-AR/histograma_II_t150.png" alt="histograma_II_t150.png"">
    <img src="./P-L03-D-simulacion-procesos-AR/histograma_II_t200.png" alt="histograma_II_t200.png"">
  </div>
</div>
#+END_EXPORT
...
#+ATTR_LATEX: :width 0.45\textwidth :center t
#+NAME: fig:RW
[[file:P-L03-D-simulacion-procesos-AR/RW.png]]
#+END_CENTER
...
Analice la composición  de lado de la derecha de la ecuación. 
...
#+ATTR_LATEX: :width 0.45\textwidth :center t
#+NAME: fig:ARMA
[[file:P-L03-D-simulacion-procesos-AR/ARMA.png]]
#+END_CENTER

* Código completo de la práctica

   | Guión completo: | [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L03-D-simulacion-procesos-AR.inp][P-L03-D-simulacion-procesos-AR.inp]] |

#+latex: \lstinputlisting{guiones/P-L03-D-simulacion-procesos-AR.inp}
...
=comb_pasado_Yt = comb_pasado_Yt + phi[1,j] * Y[i-j]=, usa ~+=~, que evita escribir =comb_pasado_Yt= dos veces. Con ~+=~ indicamos que aumente en cantidad expresada a la derecha el valor de la variable a la izquierda (logramos expresiones más compactas).
#+name: guion para simular un proceso AR
#+BEGIN_SRC gretl :eval no
nulldata 300
setobs 4 1960:01 --time-series
