...
#+Title: Lección 4.D - Simulación de paseos aleatorios
...
#+PROPERTY: P-L04-D-simulacion-paseo-aleatorio
#+BEGIN_SRC sh  :exports none  :results silent :var practica="P-L04-D-simulacion-paseo-aleatorio"
rm -fr $(pwd)/$practica
...
#+begin_src gretl :tangle guiones/P-L04-D-simulacion-paseo-aleatorio.inp :exports none :eval no
...
#+end_src
# string directory = $(pwd) ~ "/P-L04-A-simulaciones"
...
* Objetivo de la práctica
   ...
   | Guión: | [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L04-D-simulacion-paseo-aleatorio.inp][P-L04-D-simulacion-paseo-aleatorio.inp]] |

En las prácticas anteriores hemos simulado procesos estacionarios MA($q$), donde $q$ es finito.
En contraste, ahora simularemos un proceso *que ni es un MA($q$), ni tampoco es estacionario* (en varianza).
...
\]
donde las variables \(U_t\) son normales con media cero, varianza \(\sigma^2\) y \(Cov(U_t,U_j)=0\) si $\t\ne j$.
...
Su varianza crece con $t$ cuando $t\geq1$.[fn::aunque $Var(Y_t)$ es 0 para $t<1$.]
...
Puede generalizar su función añadiendo un parámetro que fije el valor inicial del paseo aleatorio, 
u otro para añadir una deriva (un incremento constante del proceso) para simular un /paseo aleatorio con deriva/:
\[Y_t = d + Y_{t-1} + U_t.\]
...
#+BEGIN_SRC gretl  :noweb tangle  :tangle ./guiones/P-L04-D-simulacion-paseo-aleatorio.inp :eval no
...
[[file:P-L04-D-simulacion-paseo-aleatorio/RandomWalks.png]]
#+END_CENTER


* Actividad 4 - Use su función en un bucle para generar muchos paseos aleatorios e inferir el comportamiento general

#+BEGIN_SRC gretl :tangle ./guiones/P-L04-D-simulacion-paseo-aleatorio.inp :eval no
...
#+ATTR_LATEX: :width 0.45\textwidth :center t
#+NAME: fig:MuchosRW
[[file:P-L04-D-simulacion-paseo-aleatorio/MuchosRandomWalks.png]]
#+END_CENTER

La figura [[fig:MuchosRW]] presenta 300 realizaciones del proceso de paseo aleatorio con la función que hemos programado. 
El proceso comienza siempre con el valor cero, pero la probabilidad de que tome valores alejados de cero crece con el tiempo. 
...
\centering
\begin{tabular}{ll}
\includegraphics[width=0.45\textwidth]{./P-L04-D-simulacion-paseo-aleatorio/histograma_t1.png} & \includegraphics[width=0.45\textwidth]{./P-L04-D-simulacion-paseo-aleatorio/histograma_t70.png}\\
\includegraphics[width=0.45\textwidth]{./P-L04-D-simulacion-paseo-aleatorio/histograma_t140.png} & \includegraphics[width=0.45\textwidth]{./P-L04-D-simulacion-paseo-aleatorio/histograma_t200.png}\\
\end{tabular}
\end{table}
\end{center}
#+END_EXPORT
...
<div class="row">
  <div class="column">
    <img src="./P-L04-D-simulacion-paseo-aleatorio/histograma_t1.png" alt="histograma_t1.png"">
    <img src="./P-L04-D-simulacion-paseo-aleatorio/histograma_t70.png" alt="histograma_t70.png"">
  </div>
  <div class="column">
    <img src="./P-L04-D-simulacion-paseo-aleatorio/histograma_t140.png" alt="histograma_t140.png"">
    <img src="./P-L04-D-simulacion-paseo-aleatorio/histograma_t200.png" alt="histograma_t200.png"">
  </div>
</div>
#+END_EXPORT
...
#+BEGIN_CENTER
#+CAPTION: Figura con la simulación de un paseo aleatorio
#+attr_org: :width 500
#+ATTR_LATEX: :width 0.45\textwidth :center t
#+NAME: fig:RW
[[file:P-L04-D-simulacion-paseo-aleatorio/RandomWalk.png]]
#+END_CENTER

#+BEGIN_CENTER
#+CAPTION: Figura con el correlograma de los datos simulados
#+attr_org: :width 500
#+ATTR_LATEX: :width 0.45\textwidth :center t
#+NAME: fig:RW
[[file:P-L04-D-simulacion-paseo-aleatorio/ACF-PACF-RW.png]]
#+END_CENTER

#+BEGIN_CENTER
#+CAPTION: Figura con el periodograma de los datos simulados
#+attr_org: :width 500
#+ATTR_LATEX: :width 0.45\textwidth :center t
#+NAME: fig:RW
[[file:P-L04-D-simulacion-paseo-aleatorio/Periodograma-RW.png]]
#+END_CENTER
...
* Código completo de la práctica
   ...
   | Guión completo: | [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L04-D-simulacion-paseo-aleatorio.inp][P-L04-D-simulacion-paseo-aleatorio.inp]] |

#+latex: \lstinputlisting{guiones/P-L04-D-simulacion-paseo-aleatorio.inp}
