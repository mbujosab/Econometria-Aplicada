...
#+end_src
(En el guion [[https://mbujosab.github.io/Econometria-Aplicada/Practicas-html/guiones/P-L03-A-simulaciones.inp][P-L03-A-simulaciones.inp]], se muestra un procedimiento diferente que guarda los estadísticos en un archivo y el gráfico en otro, sin generar iconos.
He utilizado los ficheros generados para poder mostrar los resultados a continuación).
#+latex: }
...
- En la ventana emergente escribimos =X = WN + 0.8*WN(-1)=
  ...
  (donde =WN(-1)= denota la serie =WN= retrasada un periodo).
